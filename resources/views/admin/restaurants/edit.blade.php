{{-- resources/views/admin/edit_restaurant.blade.php --}}
<x-app-layout>
                        ...
                        <form action="{{ route('admin.restaurants.update', $restaurant->id) }}" method="POST" enctype="multipart/form-data">
                            ...
                            <div class="space-y-6">
                                ...
                                <div>
                                    ...
                                    @if($restaurant->image)
                                        <div class="mb-4">
                                            <p class="text-sm text-default-600 mb-2">Current Image:</p>
                                            <img src="{{ $restaurant->image }}" class="h-32 w-32 object-cover rounded-lg">
                                        </div>
                                    @endif
                                    ...
                                    <div id="image-preview" class="hidden mt-4">
                                        <p class="text-sm text-default-600 mb-2">New Image Preview:</p>
